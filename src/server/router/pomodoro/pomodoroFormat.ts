...
export const pomodoroFormatRouter = router({
    getAllOfUsersPomodoroFormats: protectedProcedure.input(z.object({
        userId: z.string(),
    ...
    getSelectedPomodoroFormat: protectedProcedure.input(z.object({
        pomodoroFormatId: z.string(),
    })).query(async ({ input, ctx }) => {
        return await ctx.prisma.pomodoroFormat.findFirst({ where: { id: input.pomodoroFormatId } });
    }),
    createPomodoroFormat: protectedProcedure.input(z.object({
        name: z.string(),
    ...
    updatePomodoroFormat: protectedProcedure.input(z.object({
        id: z.string(),
        name: z.string(),
        workDuration: z.string(),
        breakDuration: z.string(),
    ...
    updateUsersSelectedPomodoroFormat: protectedProcedure.input(z.object({
        pomodoroFormatId: z.string(),
    })).mutation(async ({ input, ctx }) => {
